var e = {
    version: "0.2.5",
    hostname: "https://vkkkv.github.io",
    root: "/",
    statics: "/",
    ...
    loader: {start: true, "switch": false},
    search: {appID: "9NHYCM64CT", apiKey: "eeb4258336eb436bb85f07a81d02894b", indexName: "vkkkv", hits: {per_page: 10}},
    valine: {
        appId: "kCttiIRXFHdSOrgBnJAoh54Y-MdYXbMMI",
        appKey: "Nxo4WmsgjQl2gN8GxJ8NCBEm",
        placeholder: "ヽ(○´∀`)ﾉ♪",
        avatar: "mp",
        pageSize: 10,
        lang: "zh-CN",
        ...
        serverURLs: null,
        powerMode: true,
        tagMeta: {visitor: "新朋友", master: "主人", friend: "小伙伴", investor: "金主粑粑"},
        tagColor: {master: "var(--color-orange)", friend: "var(--color-aqua)", investor: "var(--color-pink)"},
        tagMember: {master: null, friend: ["deea5a8d259d17182a53be1772e4c182"], investor: null}
    },
    quicklink: {timeout: 3e3, priority: true},
    audio: ["https://music.163.com/#/playlist?id=8149667096", "https://music.163.com/#/playlist?id=736694903"],
    fireworks: ["rgba(95,90,162,.9)", "rgba(242,201,76,.9)", "rgba(155,222,172,.9)", "rgba(242,139,130,.9)", "rgba(170,198,229,.9)"]
};
...
const N = u("#sidebar");
const O = u("#brand");
var j = u("#tool"), I, H, A, S;
var q = u("#search");
var R, _, P;
var D = window.innerHeight;
var B = window.innerWidth;
var W = 0, Y = window.location.href;
var z;
...
const Q = function (e) {
    ...
    _ = E.height();
    P = _ + u("#waves").height();
    if (B != window.innerWidth) ae(null, 1);
...
const K = function (e) {
    ...
    N.toggleClass("affix", window.pageYOffset > P && document.body.offsetWidth > 991);
...
const ee = function (t) {
    ...
    if (a) n = u(decodeURI(a)); else {
        n = e.auto_scroll ? parseInt(d.get(Y)) : 0
    }
    if (n) {
        c(n);
        W = 1
...
const ce = function () {
    u.each(".menu .item:not(.title)", function (t) {
        ...
        if (!a) return;
        var i = a.pathname === location.pathname || a.pathname === location.pathname.replace("index.html", "");
        var r = !e.root.startsWith(a.pathname) && location.pathname.startsWith(a.pathname);
...
const fe = function () {
    ...
    u.each("ol[start]", function (e) {
        e.style.counterReset = "counter " + parseInt(e.attr("start") - 1)
    });
